    ...
    return (
        <>
            ...
            <div className="balsamiq-component">
                ...
                <div style={{ left: 0, width: '100%', height: 0, position: 'relative', paddingBottom: '62.5%' }}>
                    <iframe
                        src="https://static.balsamiq.cloud/1604/embed/index.html?i=https%3A%2F%2Fshare.balsamiq.com%2Fc%2Fhmm61GZQr6BUQSCZe5fhYa.jpg"
                        style={{ top: 0, left: 0, width: '100%', height: '100%', position: 'absolute', border: 0 }}
                        allowFullScreen
                    ></iframe>
                </div>
